...
export const Pacientes = () => {
  ...
  function salvar(dados, e) {
    ...
    data.append('hospital', dados.hospital);
    data.append('cpf', dados.cpf);
    data.append('data_nascimento', dados.data_nascimento);
    data.append('situacao', dados.situacao);

    if (params.id) {
      PacienteService.update(params.id, dados)
    } else {
      apiProjeto.post('/addPaciente', data)
      .then(() => {
